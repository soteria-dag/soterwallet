...
var helpDescsEnUS = map[string]string{
	...
	"getbalance--result0":    "The balance of 'account' valued in soter",
	"getbalance--result1":    "The balance of all accounts valued in soter",
	...
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in SOTER/KB",
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in soter",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in soter",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in soter",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and soter amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in soter",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in soter",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in soter",
	...
	"listtransactionsresult-amount":             "The value of the transaction output valued in soter",
	...
	"listunspentresult-amount":        "The amount of the output valued in soter",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in soter",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in soter to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in soter",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in soter",
	...
	"settxfee-amount":    "The new fee increment valued in soter",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in soter.",
