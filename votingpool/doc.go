...
/*
Package votingpool provides voting pool functionality for soterwallet.

Overview

The purpose of the voting pool package is to make it possible to store
soter tokens using m-of-n multisig transactions. A pool can have multiple
...
StartWithdrawal method:
	...
	dustThreshold: the minimum amount of nanoSoter an input needs to be considered eligible
