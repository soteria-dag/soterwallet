...
type RescanJob struct {
	...
	OutPoints   map[wire.OutPoint]soterutil.Address
...
// rescan.
func (w *Wallet) Rescan(addrs []soterutil.Address, unspent []wtxmgr.Credit) error {
...
func (w *Wallet) rescanWithTarget(addrs []soterutil.Address,
	unspent []wtxmgr.Credit, startStamp *waddrmgr.BlockStamp) error {

	outpoints := make(map[wire.OutPoint]soterutil.Address, len(unspent))
