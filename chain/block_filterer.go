...
func NewBlockFilterer(params *chaincfg.Params,
	...
	foundOutPoints := make(map[wire.OutPoint]soterutil.Address)
...
// interest.
func (bf *BlockFilterer) FilterOutputAddrs(addrs []soterutil.Address) bool {
	var isRelevant bool
