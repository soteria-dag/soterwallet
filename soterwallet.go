...
import (
	...
	"github.com/soteria-dag/soterwallet/rpc/legacyrpc"
...
// startChainRPC opens a RPC client connection to a soterd server for blockchain
...
func startChainRPC(certs []byte) (*chain.RPCClient, error) {
	...
	rpcc, err := chain.NewRPCClient(activeNet.Params, cfg.RPCConnect,
		cfg.SoterdUsername, cfg.SoterdPassword, certs, cfg.DisableClientTLS, 0)
	if err != nil {
		return nil, err
	}
	err = rpcc.Start()
